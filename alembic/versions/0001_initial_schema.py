...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM(*USER_ROLE_VALUES, name="user_role", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("subledger_type", postgresql.ENUM(*SUBLEDGER_VALUES, name="subledger_type", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("subledger_type", postgresql.ENUM(*SUBLEDGER_VALUES, name="subledger_type", create_type=False)),
        sa.Column("category", postgresql.ENUM(*TEMPLATE_CATEGORY_VALUES, name="template_category", create_type=False)),
        ...
        sa.Column(
            "visibility",
            postgresql.ENUM(*TEMPLATE_VISIBILITY_VALUES, name="template_visibility", create_type=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(*RUN_STATUS_VALUES, name="run_status", create_type=False), server_default="PENDING"),
    ...
    op.create_table(
        ...
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("projects.id")),
        sa.Column("action", postgresql.ENUM(*AUDIT_ACTION_VALUES, name="audit_action", create_type=False), nullable=False),
